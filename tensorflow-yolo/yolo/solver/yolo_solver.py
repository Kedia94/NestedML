...
#    return apply_gradient_op
  ...
  def solve(self):
    saver1 = tf.train.Saver(self.net.pretrained_collection, write_version=1)#tf.train.SaverDef.V2)
    #saver1 = tf.train.Saver(self.net.trainable_collection)
    saver2 = tf.train.Saver(self.net.trainable_collection, write_version=1)#tf.train.SaverDef.V2)
